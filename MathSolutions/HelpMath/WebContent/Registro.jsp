<%@page import="br.com.mathsolutions.bo.UsuarioBO"%>
<%@page import="br.com.mathsolutions.model.service.NovoRegistroServlet"%>
...
<body>
	...
	<div class="img1-2 alturaImg" alt="Imagem">
		<div class="text1 Sketch_Block-font txtIndex">Registre sua nova
			conta</div>
	</div>
	<!-- modal -->
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Registre sua
					nova Conta</h5>
			</div>
			<div class="modal-body">
				<form name="dados" id="dados" method="post" action="NovoRegistro">
